...
const ProductPage  = async ({params,searchParams}: {params: Promise<{id:string}>;  searchParams:Promise<{color:string; size:string}>}) => {
    ...
    const selectedSize = (size || product.sizes[0]).toLowerCase();
    const selectedColor = (color || product.colors[0]).toLowerCase();
    ...
    return <div className="flex flex-col gap-4 lg:flex-row md:gap-12 mt-12">
        ...
        <p className="text-gray-500 text-xs">
          ...
          . You authorize us and our third party payment providers to charge your card
          for this purchase and future purchases according to our {" "}

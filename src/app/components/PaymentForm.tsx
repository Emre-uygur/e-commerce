  ...
  return (
    <form className="flex flex-col gap-4 " onSubmit={handleSubmit(handlePaymentForm)}>
      <div className="flex flex-col gap-1">  
        ...
        <input className="border-b border-grey-200 py-2 outline-none text-sm " type="text"  id="cardHolder" placeholder="emre" {...register("cardHolder")}/>
        ...
        <input className="border-b border-grey-200 py-2 outline-none text-sm " type="text"  id="cardNumber" placeholder="1234555" {...register("cardNumber")}/>
        ...
        <input className="border-b border-grey-200 py-2 outline-none text-sm " type="text"  id="expirationDate" placeholder="06/2026" {...register("expirationDate")}/>
        ...
        <input className="border-b border-grey-200 py-2 outline-none text-sm " type="text"  id="cvv" placeholder="123" {...register("cvv")}/>
        ...
        <button type="submit" className="w-full bg-gray-800 text-white p-3 rounded-lg cursor-pointer hover:bg-gray-900 transition-all duration-300 flex items-center justify-center gap-2">
                            Checkout
